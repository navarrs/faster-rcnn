...
options.test_path = 'images/test_examples/'
...
# mask = nn.mask(feature_map_input, roi_input, C.num_rois, 
  #             nb_classes=len(class_mapping), trainable=True)
...
#------------
# layer_idx = utils.find_layer_idx(model_rpn, 'rpn_out_regress')
# model_rpn.layers[layer_idx].activation = activations.linear
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    heatmap = visualize_saliency(model_rpn, -1, filter_indices=0, seed_input=image, 

...
%  pre-trained model from from the VGG16 network. The objective of this
%  approach is to detect wheelchairs given a cluttered environment and 
%  analyze how well it is able to predict the prescence of a wheelchair.  
...
wheelchair_data = load('ROI_reduced_dataset_test.mat');
wheelchairs = wheelchair_data.wheelchair; 
...
input_layer = imageInputLayer([224 224 3], ...      % size
